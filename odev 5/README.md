[PATİKA](https://app.patika.dev/) dev in Php dersleri çerçevesinde çelıştığımız OPP için verilen 5.ci ödevimiz.
...
[OPP Odev: Asansör Simülasyonu](/images/lift_uml.png)